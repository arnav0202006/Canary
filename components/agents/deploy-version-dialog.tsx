...
type Step = "version" | "deploy" | "result"
...
export function DeployVersionDialog({ agentId, agentName }: { agentId: string; agentName: string }) {
        ...
        {step === "version" && (
          <>
            <DialogHeader>
              ...
              <DialogDescription>
                Store a new prompt version for <span className="font-medium text-foreground">{agentName}</span>.
              </DialogDescription>
            </DialogHeader>
